...
const BillingInterface: React.FC<BillDetailsProps> = ({ billArray }) => {
        ...
        <div className="p-6">
          ...
          <div className="flex justify-between mb-6">
            <div>
              ...
              <p>{billArray.issueDate}</p>
            </div>
            <div>
              <p className="text-sm text-gray-600">Due Date</p>
              <p>{billArray.dueDate}</p>
            </div>
            <div>
              <p className="text-sm text-gray-600">Bill Number</p>
              <p>{billArray.billNumber}</p>
            </div>
          </div>
          ...
          <div className="space-y-2">
            <div className="flex justify-between">
              <span>Subtotal</span>
              <span>{billArray.subtotal}</span>
            </div>
            <div className="flex justify-between">
              <span>Tax</span>
              <span>{billArray.tax}</span>
            </div>
            <div className="flex justify-between font-bold">
              <span>Grand Total (USD)</span>
              <span>{billArray.grandTotal}</span>
            </div>
            <div className="flex justify-between">
              <span>Amount Paid</span>
              <span>{billArray.grandTotal || 0}</span>
            </div>
            <div className="flex justify-between font-bold">
              <span>Amount Due (USD)</span>
              <span>{billArray.amountDue}</span>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center">
          <div className="bg-white rounded-lg p-6 max-w-md w-full">
            ...
            <div className="space-y-4">
              <p className="text-sm">
                Amount due: Rs. {billArray.amountDue.toFixed(2)}
              </p>
