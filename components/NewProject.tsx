...
const NewProject: React.FC<NewProjectProps> = ({ clients, teamMembers }) => {
  ...
  const calculateTotalCost = () => {
    if (selectedType === "flat-rate") {
      ...
      return services.reduce((total, service) => 
        total + (service.hours * service.rate), 0
      );
    }
  };
  ...
  const handleServiceChange = (index: number, field: keyof Service, value: string | number) => {
    ...
    if (field === 'hours' || field === 'rate') {
      service[field] = typeof value === 'string' ? parseFloat(value) || 0 : value;
  ...
  const removeTeamMember = (memId: string) => {
    setSelectedTeamMembers(selectedTeamMembers.filter(member => member.memId !== memId));
  };
  ...
  const handleSave = async () => {
    ...
    const projectData = {
      ...
      totalHours: selectedType === "hourly" ? calculateTotalHours() : parseInt(totalHours) || 0,
      status,
    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-20 to-white p-8">
      ...
      <div className="flex flex-row justify-between items-center mb-6">
        <div>
          ...
          <p className="text-gray-500 mt-2">Create a new project with all necessary details</p>
        </div>
                  ...
                  <div>
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-500">{client.businessType} • {client.location}</p>
                      </div>
                    </div>
          ...
          <div className="mb-8">
            ...
            <div className="flex flex-wrap gap-3">
              {selectedTeamMembers.length === 0 ? (
                <div className="text-gray-500 italic">No team members assigned yet</div>
              ) : (
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <div className="flex items-center gap-2 mt-1">
                          <select
                            value={member.role}
                            onChange={(e) => updateTeamMemberRole(member.memId, e.target.value)}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    type="number"
                    value={selectedType === "hourly" ? calculateTotalHours() : totalHours}
          ...
          <div className="mt-8">
            ...
            <div className="space-y-4">
              {services.map((service, index) => (
                <div key={index} className="border border-gray-200 rounded-lg p-4 group hover:border-blue-300">
        ...
        <div className="w-full lg:w-80">
          ...
          <div className="bg-white rounded-xl shadow-md p-6 mb-6">
                ...
                >
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <h3 className="text-gray-900 font-medium">Project Type</h3>
                      ...
                      return (
                        ...
                        >
                          <div className="flex items-center gap-3">
                            ...
                            <span className={selectedType === type.id ? "text-blue-600 font-medium" : "text-gray-700"}>
                              {type.label}
                            </span>
                          </div>
            ...
            <div className="border-t pt-6">
              <h3 className="text-gray-900 font-medium mb-4">Project Summary</h3>
              <div className="space-y-3">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="font-medium">{selectedTeamMembers.length}</span>
                </div>
                <div className="flex justify-between">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="font-medium">
                    {selectedType === "hourly" ? calculateTotalHours() : totalHours}
                  </span>
                </div>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-xl shadow-xl w-full max-w-2xl max-h-[90vh] overflow-hidden">
            <div className="p-6 border-b">
              ...
              <p className="text-gray-600 mt-2">Select team members to add to this project</p>
                  ...
                  {filteredTeamMembers.map((member) => (
                    ...
                    >
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        {selectedTeamMembers.some(m => m.memId === member.memId) ? (
                          <button
                            onClick={() => removeTeamMember(member.memId)}
              ...
              <div className="flex justify-between items-center">
                <div>
                  <p className="text-gray-600">
                    Selected: <span className="font-medium">{selectedTeamMembers.length}</span> members
                  </p>
                </div>
                <button
                  onClick={() => {
