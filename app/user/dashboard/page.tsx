  ...
  return (
    <div className="flex flex-col items-center p-4 bg-gray-100 min-h-screen">
      <main className="w-full">
        ...
        {/* Card Section */}
        <div className="grid grid-cols-1 md:grid-cols-4 lg:grid-cols-4 gap-4 mb-10">
          <SummaryCard
            icon={<FaUsers />}
            title="Quotations"
            url="quotations"
        ...
        <div className="flex flex-col justify-normal gap-8">
          ...
          {/* Revenue Section */}
          <div className="bg-white p-4 rounded-lg shadow">
            <h2 className="text-lg font-semibold mb-4">Revenue and Expenses</h2>
            {/* Placeholder for Bar Chart */}
          ...
          {/* Profit Section */}
          <div className="bg-white p-4 rounded-lg shadow">
            <h2 className="text-lg font-semibold mb-4">Total profit</h2>
            {/* Placeholder for Bar Chart */}
            <div className="h-64 bg-gray-200 flex items-center justify-center rounded">
...
const SummaryCard: React.FC<SummaryCardProps> = ({
  ...
  <div>
    <div className="bg-white p-4 rounded-lg shadow-lg h-[65vh] flex flex-col justify-between hover:shadow-2xl transition-shadow">
      ...
      <div>
        <h2 className="text-sm font-bold mb-2 text-gray-800">{htag}</h2>
        <p className="text-gray-600 text-xs">{ptag}</p>
      </div>
      <button
