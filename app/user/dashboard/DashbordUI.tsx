...
//   const userName = "John Doe";
  ...
  const statsCards = [
    ...
    },
    {
      ...
      change: `+${Math.round(activeProjects / 10)}`,
      trend: "up",
    ...
    },
    {
      ...
      change: `-${Math.round(outstandingInvoicesCount / 20)}`,
      trend: outstandingInvoicesCount > 10 ? "down" : "up",
      icon: <FaFileInvoice className="text-amber-500" />,
      color: "bg-gradient-to-r from-amber-50 to-amber-100",
      description: `$${outstandingAmount.toFixed(2)} total`,
    },
    {
      title: "Total Clients",
      value: totalClients.toString(),
      change: `+${Math.round(totalClients / 8)}`,
      trend: "up",
    ...
    },
    {
      ...
      change: `+${Math.round(paidInvoices / 15)}`,
      trend: "up",
    ...
    },
    {
      ...
      value: recentInvoices.toString(),
      change: `+${Math.round(recentInvoices / 5)}`,
      trend: "up",
      icon: <FaFileInvoice className="text-indigo-500" />,
  ...
  return (
    <div className="p-4 md:p-6 bg-gray-10 min-h-screen">
      ...
      {/* Stats Cards with real data - Now 6 cards in 3 columns on large screens */}
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-4 mb-8">
        {statsCards.map((stat, index) => (
          <div
            key={index}
            className={`${stat.color} p-5 rounded-xl shadow-sm border border-gray-100`}
          >
      ...
      {/* Alternative: 4 main cards with 2 additional smaller cards below */}
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-5">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              <div className="bg-blue-50 p-4 rounded-lg">
                <div className="flex items-center">
                  <FaFileInvoice className="text-blue-600 text-xl mr-3" />
                  <div>
              ...
              <div className="bg-indigo-50 p-4 rounded-lg">
                <div className="flex items-center">
                  <FaFileInvoice className="text-indigo-600 text-xl mr-3" />
                  <div>
...
//   img,
  ...
  <div
    className={`${bgColor} p-4 rounded-lg border border-gray-200 hover:shadow-md transition-shadow`}
  >
    <div className="flex items-center gap-3 mb-3">
      <div className={`p-2 rounded-lg ${iconColor} bg-white`}>{icon}</div>
