        ...
        <div className="bg-white rounded-lg p-8 shadow-sm">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center space-y-4">
              <div className="bg-blue-500 rounded-full p-6 w-24 h-24 mx-auto flex items-center justify-center">
            ...
            <div className="text-center space-y-4">
              <div className="bg-pink-200 rounded-full p-6 w-24 h-24 mx-auto flex items-center justify-center">
                <Timer className="w-12 h-12 text-pink-500" />
              </div>
              <h3 className="text-lg font-semibold">Track Time</h3>
              <p className="text-gray-600">
            ...
            <div className="text-center space-y-4">
              <div className="bg-yellow-100 rounded-full p-6 w-24 h-24 mx-auto flex items-center justify-center">
                <LineChart className="w-12 h-12 text-yellow-500" />
              </div>
              <h3 className="text-lg font-semibold">View Client Report</h3>
              <p className="text-gray-600">
